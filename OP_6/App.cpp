...
int App::start() {
    ...
    assert(findBackward(static_cast<ForwardIterator>(numbers3.begin()), static_cast<ForwardIterator>(numbers3.end()), 2) == --numbers3.end());
    assert(findBackward(static_cast<ForwardIterator>(numbers3.begin()), static_cast<ForwardIterator>(numbers3.end()), 5) == numbers3.end());
}